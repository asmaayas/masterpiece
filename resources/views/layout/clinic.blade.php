...
<div class="card">
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <div class="flex" >
			<img src="{{ asset('img/clinc.jpg') }} " height="150" width= "150px" alt="clinic name" >
			<!-- <span>Clinic Name</span>  -->
			<h5 style="margin-left: 15px;"><span class="color"> Clinic Name </span><br><span>specialty</span></h5>
		</div> <br>
		<h5>Description</h5>
